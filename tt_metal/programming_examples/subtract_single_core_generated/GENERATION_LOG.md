...
4. If errors, run: ./generate_kernel.py --refine /home/m48chen/tt-metal/tt_metal/programming_examples/subtract_single_core_generated
...
Requirements:
- Find the subtraction (C = A - B) API functions in the knowledge base
...
```
Generate a TT-Metal reader kernel for single-core subtraction (C = A - B).
...
```
Generate a TT-Metal writer kernel for single-core subtraction (C = A - B).

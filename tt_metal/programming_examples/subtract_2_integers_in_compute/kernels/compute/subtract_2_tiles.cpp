...
void MAIN {
    ...
    // core. They work together to perform the subtraction of two input tiles and store the result in the output tile to
    // the output circular buffer. Which is then picked up by the writer kernel and written back to DRAM.
    ...
    // acquire 8 tile registers to perform the subtraction
    tile_regs_acquire();  // Math

    // Take data from cb_in0 offset 0th page and
    // cb_in1 offset 0th page. Subtract them

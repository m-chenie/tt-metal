...
**Generated at:** 2025-11-11 15:21:11
**Kernel Type:** writer
...
```
Generate a TT-Metal writer kernel for single-core diode current equation (I = isat × (exp(V/vj) - 1)).
...
- User Prompt Length: 350 characters
- Total Prompt Length: 15,134 characters
- Estimated Tokens: ~3,783 tokens

...
**Generated at:** 2025-11-11 15:21:08
**Kernel Type:** compute
...
```
Generate a TT-Metal compute kernel for the diode equation: isat × (exp(V/vj) - 1)
...
Filename: kernels/compute/diode_equation.cpp
...
- User Prompt Length: 447 characters
- Total Prompt Length: 15,231 characters
- Estimated Tokens: ~3,807 tokens
